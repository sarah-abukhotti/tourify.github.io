...
$query = "UPDATE reservation SET status =1 where id=".$controll."";
...
<p><span style="font-size: 24px;">Your Requests Data Approved :&nbsp;</span></p>
...
<tr style="height: 22.4px;">
<td style="height: 22.4px; padding-left: 40px;"><span style="font-size: 18px;"><sub><strong>
Approved Time </strong></sub></span></td>
<td style="height: 22.4px;">&nbsp; '.date("Y-m-d h:i:sa") .'</td>
</tr>
 
</tbody>
</table>
<h2 align="left">Your Requests Approved</h2>
